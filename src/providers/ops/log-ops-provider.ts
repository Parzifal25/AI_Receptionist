...
import type { OpsProvider, OpsRecordInput, OpsRecordKind, OpsRecordResult } from "@/core/ports/ops-provider";
 ...
 * FSM/ERP back-end is connected — swapping in OpsCorp is a factory change.
 */
